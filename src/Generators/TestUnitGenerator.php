...
class TestUnitGenerator extends TemplateGenerator
{
    ...
    function renderPermissions() {
        return view('devesharp-generators::Tests/permissions', [...$this->templateData->toArray(), ...$this->additionalData, ...$this->getData()])->render();
    }

    public function handle()
    {
        $file = $this->fileSystem->readFile($this->config->permissionsPath);
