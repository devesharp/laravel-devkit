...
class ControllerGenerator extends TemplateGenerator
{
    ...
    function renderRoutes() {
        return view('devesharp-generators::Routes/route-default', [...$this->templateData->toArray(), ...$this->additionalData, ...$this->getData()])->render();
    }
    ...
    public function handle()
    {
        ...
        if ($data['withRoutes']) {
            $string = "'" . $data['resourceURI'] . '/';
            $string2 = "'" . $data['resourceURI'] . "'";

            if (strpos($file, $string) == false && strpos($file, $string2) == false) {
